...
def income_statement(trial_balance):
    ...
    other_income = (other_lease_income+other_investment_income+other_billpay_income+other_dealershipinsurancefee_income+other_misc)*-1
    total_other_income = (insurance_commissions+total_licensing_income+other_income)
    ...
    ws[f'{idx[current_month]}{other_income}'].value = total_other_income
    ws[f'{idx[current_month]}{total_other}'].value = insurance_commissions+total_licensing_income+total_other_income
    ...
    ws[f'{idx[current_month]}{net_income}'].value = (net_income-total_operating_expenses)-income_tax_provision
