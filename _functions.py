...
def income_statement():
    ...
    ws[f'{idx[current_month]}{nii}'].value = f'={idx[current_month]}{gnii}-{idx[current_month]}{pcl}'
    ...
    ws[f'{idx[current_month]}{nii_net}'].value = f'={idx[current_month]}{nii}+{idx[current_month]}{total_other}'
    ...
    ws[f'{idx[current_month]}{toe}'].value = f'={idx[current_month]}{sb}+{idx[current_month]}{ooe}+{idx[current_month]}{rc}'
    ws[f'{idx[current_month]}{oibit}'].value = f'={idx[current_month]}{nii_net}-{idx[current_month]}{toe}'
    ws[f'{idx[current_month]}{pfit}'].value = income_tax_provision
    ws[f'{idx[current_month]}{net_income_id}'].value = f'={idx[current_month]}{oibit}-{idx[current_month]}{pfit}'
    return wb.save(f'execute/{current_month} GAAP IS.xlsx')